...
root = Tk()
root.title("Denomination Project")
...
label1 = Label(root,
                text = "Hi User! Welcome to Denomination Calculator!",
                bg="light blue")
...
def topwin():
    ...
    label = Label(top, text="Enter total amount here", bg="light gray")
    entry = Entry(top)
    ...
    def calculator():
        try:
            ...
            messagebox.showerror("error","please enter a valid number, try again!")
